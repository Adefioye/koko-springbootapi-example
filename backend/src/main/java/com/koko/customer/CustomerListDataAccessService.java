...
public class CustomerListDataAccessService implements CustomerDao{
    ...
    static {
        ...
        Customer alex = new Customer(1, "Alex", "alex@gmail.com", "password", Gender.MALE, 21);
        Customer jamila = new Customer(2, "Jamila", "jamila@gmail.com", "password", Gender.MALE, 19);
        customers.add(alex);
